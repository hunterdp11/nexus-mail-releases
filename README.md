<div align="center">
  <img src="app_icon_rounded.png" width="120" style="border-radius: 24px; margin-bottom: 16px;" />
  
  <h1>Nexus Mail</h1>
  <p><strong>A high-performance, secure, and modern temporary email client for Android.</strong></p>
